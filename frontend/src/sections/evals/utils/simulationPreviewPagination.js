export const SIMULATION_PREVIEW_PAGE_SIZE = 50;
export const SIMULATION_PREVIEW_HTTP_TIMEOUT_MS = 9000;
...
export function simulationPreviewRequestError(error) {
  ...
  if (transportCode === "ECONNABORTED" || transportCode === "ETIMEDOUT") {
    return {
      message:
        "The preview read exceeded 9 seconds. Retry when the data service is ready.",
      restartRequired: false,
      terminal: false,
    };
  }
