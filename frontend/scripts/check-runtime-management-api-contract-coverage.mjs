...
const MIN_APP_WIDE_RUNTIME_BACKED_VALIDATED_REQUEST_DECORATORS = 361;
const MAX_APP_WIDE_DIRECT_SWAGGER_AUTO_SCHEMA_DECORATORS = 396;
const MAX_APP_WIDE_DOC_ONLY_INPUT_CONTRACT_DECORATORS = 114;
